...
duration	=	3600
warm		=	300
TESTname	=	"Cinebench R20 - Multi-thread - Pulse"
MULTI		=	TRUE
...
if (interactive())	{
	# setwd("C:/Users/packe/Desktop/Open Share/@Thermal Scripts/Data CPU/AMD Wraith Prism/2021-03-31 12.42/")
	setwd("E:/Users/Jim/My Documents/OCC/@Reviews/Thermal Scripts Articles/Data CPU/AMD Wraith Prism/2021-03-31 12.42/")
}	else	{
	pdf(NULL)
}
